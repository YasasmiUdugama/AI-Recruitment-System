...
urlpatterns = [
    ...
    path('submit-answer/', views.submit_answer_api, name='submit_answer'),  # NEW: consolidated per-question submission
    ...
    path('portal-questions/', views.interview_portal_questions_api, name='interview_portal_questions'),  # NEW
